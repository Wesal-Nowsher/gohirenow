...
class RegisterHire extends Component {
    state={
        cname:"",
        email:"",
        country:"",
    ...
    handleSubmit= (event) => {
        ...
        //     this.setState({showErr:"Password must have length 6 character and atleast one capital character one small character and one special character"})
        // }
                            ...
                            <div className="register-form">
                                <div className="hire-work-buttons ">
                                    ...
                                    <p className="text-center" style={{color:"Red"}}>{showErr}</p>
                                        <button className="btn text-uppercase" type="submit" onClick={this.handleSubmit}>Sign up</button>
                                    </div>
...
export default withRouter(RegisterHire);